...
public enum ReservationErrorCode implements ErrorCode {
    ...
    THEME_STORE_MISMATCH(HttpStatus.BAD_REQUEST, "해당 매장에 속한 테마가 아닙니다."),
    RESERVATION_UPDATE_DEADLINE_PASSED(HttpStatus.UNPROCESSABLE_ENTITY, "예약 변경 및 취소 가능한 시간이 지났습니다."),
    ;
